...
cd paris;
echo paris ;
/home/achanhon/divers_lib/libsvm-3.22/svm-train -t 0 train.txt model.txt > lol.txt
/home/achanhon/divers_lib/libsvm-3.22/svm-predict test.txt model.txt res.txt 
cd .. ;
